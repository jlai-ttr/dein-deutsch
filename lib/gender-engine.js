...
const SUFFIX_RULES = [
  ...
  // Compound light-words: Tageslicht, Mondlicht, Sonnenlicht, Blitzlicht — all das
  // L200: -licht compound rule. All common -licht words are neuter (light = "Licht", neuter root).
  // Pflicht (duty) is a different word but shares ending — handled by A1_A2 lookup (tier > rule).
  { suffix: /licht$/, gender: 'das', plural: 'er', score: 95,
    note: '-licht (Neut, light compounds: Tageslicht, Mondlicht, Sonnenlicht, etc.)',
    exceptions: ['die Pflicht'] },
